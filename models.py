...
#         # Residual blocks
#         in_features = 256
#         self.conv_4 = nn.Sequential(nn.ReflectionPad2d(1),
#                         nn.Conv2d(in_features, in_features, 3),
#                         nn.InstanceNorm2d(in_features),
#                         nn.LeakyReLU(0.2),
#                         nn.ReflectionPad2d(1),
...
#         # Residual blocks * 9
#         # batch size x 256 x 64 x 64
#         c4_1 = c3 + self.conv_4(c3)
#         c4_2 = c4_1 + self.conv_4(c4_1)
#         c4_3 = c4_2 + self.conv_4(c4_2)
#         c4_4 = c4_3 + self.conv_4(c4_3)
#         c4_5 = c4_4 + self.conv_4(c4_4)
#         c4_6 = c4_5 + self.conv_4(c4_5)
#         c4_7 = c4_6 + self.conv_4(c4_6)
#         c4_8 = c4_7 + self.conv_4(c4_7)
#         c4 = c4_8 + self.conv_4(c4_8)
#
#         # Decoding
